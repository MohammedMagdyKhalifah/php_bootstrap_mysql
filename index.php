...
<div class="position-relative overflow-hidden p-3 p-md-5 text-center bg-dark text-white">
    <div class="col-md-6 p-lg-5 mx-auto">
        <img src="./images/messi.png" alt="">
        <h1 class="display-4 fw-bold">اربح معنا</h1>
        <p class="fw-normal text-light mb-3 ">باقي على فتح التسجيل</p>
        <!-- Display the countdown timer in an element -->
        <h3 id="countdown"></h3>
        <p class="fw-normal text-light mb-3">للسحب على ربح نسخة مجانية</p>
    </div>
    <ul class="list-group list-group-flush text-light">
        <h3>للدخول على السحب يرجى اتباع ما يلي :</h3>
        <li class="list-group-item text-light">تابع البث المباشر على صفحتي على يوتيوب</li>
        <li class="list-group-item text-light">سأقوم ببث لمدة ساعة للإجابة عن اسئلتكم</li>
        <li class="list-group-item text-light">خلال فترة البث سيتم اتاحة التسجيل وكتابة اسماءكم وايملاتكم</li>
        <li class="list-group-item text-light">بنهاية البث سيتم اختيار شخص واحد من قاعدة البيانات</li>
        <li class="list-group-item text-light">الرابح سيحصل على نسخة مجانية</li>
    </ul>
</div>
<div class="container">
